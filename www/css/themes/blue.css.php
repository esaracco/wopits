...
.postit.selected {
  border-color:#007bff;
  box-shadow:0px 0px 25px 5px #82b5ea;
}
...
.modal:not(.no-theme) .modal-dialog.shadow .modal-footer {
  background-color: #0c68ce !important;
  color:#fff !important;
}

.modal:not(.no-theme) .modal-dialog.shadow .modal-content {
  border-color: #0c68ce !important;
}
...
.btn-secondary,
.btn-info {
  background-color: #5c9bdf !important;
