...
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Walls</b> Fixed a issue with elements editing.</p>")?>
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Relationships</b> Fixed a issue with relationships creation.</p>")?>
</div>
