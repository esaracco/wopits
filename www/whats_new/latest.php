...
<?=_("<p><b><i class='fas fa-broom fa-fw'></i>Relations</b> Cleaning & optimization.</p>")?>
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Notes</b> Fixed some issues with dragging & deletion.</p>")?>
</div>
