...
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Global</b> Fixed an issue with session timeout.</p>")?>
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Accounts</b> Fixed an issue with accounts creation.</p>")?>
</div>
