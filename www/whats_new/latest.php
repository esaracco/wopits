...
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Sticky notes</b> Fixed an issue with non-existent images.</p>")?>
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Sticky notes</b> Fixed an issue with external links filtering.</p>")?>
<?=_("<p><b><i class='fas fa-smile-beam fa-fw'></i>Sticky notes</b> Improved management of links in notes content.</p>")?>
</div>
