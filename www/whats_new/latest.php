...
<?=_("<p><b><i class='fas fa-broom fa-fw'></i>WebSocket</b> Some WebSocket heartbeat rework. <i>Contact us ASAP if you encounter timeouts problem!</i></p>")?>
<?=_("<p><b><i class='fas fa-bug fa-fw'></i>Walls</b> Fixed issue with cloning walls.</p>")?>
</div>
