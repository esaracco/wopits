...
?>
  ...
  Object.assign(Plugin.prototype, {
    ...
    _display(d) {
      H.loadPopup('postitAttachments', {
        ...
        cb: ($p) => {
          ...
          p.querySelector('.modal-body .list-group').innerHTML = body;
    ...
    _eventShowCollapse(e) {
      ...
      const liActive = $_mainPopup[0].querySelector('div.active');
          ...
          if (H.checkUploadFileSize({size: e.total}) && e.target.result) {
            H.fetchUpload(
              ...
              (d) => {
                ...
                const $body = $_mainPopup.find('.list-group');
