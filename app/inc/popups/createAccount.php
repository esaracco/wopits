    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group mb-1">
          ...
          <input type="text" class="form-control" name="username" value="" required placeholder="<?=_("login")?>" autocorrect="off" autocapitalize="none" autofocus>
        </div>
        <div class="input-group mb-1">
          <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-key fa-fw"></i></span></div>
          <input class="form-control" type="password" name="password" value="" required placeholder="<?=_("password")?>">
        </div>

        <div class="input-group mb-1">
          <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-signature fa-fw"></i></span></div>
          <input type="text" class="form-control" name="fullname" value="" required placeholder="<?=_("full name")?>" autocorrect="off">
        </div>

        <div class="input-group mb-1">
          <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-envelope fa-fw"></i></span></div>
          <input class="form-control" type="email" name="email" value="" required placeholder="<?=_("email")?>">
        </div>
        </div>
