...
- Install Apache, MariaDB or MySQL and PHP 7 (with `php-mysql`, `php-imagick`, `php-zip` and `php-ldap`). `php-ldap` will be required only if you intend to use LDAP authentication.
